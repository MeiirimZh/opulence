      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            icon: SvgPicture.asset('assets/icons/calendar.svg', width: 24, height: 24)
          ),
        ],
      ),
      body: Padding(padding: EdgeInsets.only(left: 20, top: 50), child:
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          spacing: 10.0,
          children: [
          Text('Доходы', style: TextStyle(
            fontSize: 16,
          )),
          Table(
